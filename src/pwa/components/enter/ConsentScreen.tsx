  ...
  return (
    <div className="wizard-step">
      ...
      <div>
        ...
        <p style={{ fontSize: 13, lineHeight: 1.5, color: 'var(--text-muted)' }}>Toda la información recopilada hoy se mantendrá privada.</p>
      </div>

      <div>
        <p style={{ fontSize: 16, lineHeight: 1.5, marginBottom: 4 }}>You may decline to answer any question.</p>
        <p style={{ fontSize: 13, lineHeight: 1.5, color: 'var(--text-muted)' }}>Puede negarse a responder cualquier pregunta.</p>
      </div>
